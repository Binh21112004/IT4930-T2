...
headers = {
    ...
    'Referer': 'https://tiki.vn/bo-co-vua-nam-cham-ban-cung-la-hop-dung-ubon-p278894490.html',
...
df_id = pd.read_csv('data/4-toys-tiki/result/product_id_ncds.csv')
...
df_comment.to_csv('data/4-toys-tiki/result/comments_data_ncds.csv', index=False)