...
df_id = pd.read_csv('data/bach-hoa-online-tiki/result/product_id_ncds.csv')
...
df_comment.to_csv('data/bach-hoa-online-tiki/result/comments_data_ncds.csv', index=False)
print(f'Saved {len(result)} comments to data/bach-hoa-online-tiki/result/comments_data_ncds.csv')