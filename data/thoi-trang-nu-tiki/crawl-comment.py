...
df_id = pd.read_csv('data/thoi-trang-nu-tiki/result/product_id_ncds.csv')
...
df_comment.to_csv('data/thoi-trang-nu-tiki/result/comments_data_ncds.csv', index=False)
print(f'Saved {len(result)} comments to data/thoi-trang-nu-tiki/result/comments_data_ncds.csv')