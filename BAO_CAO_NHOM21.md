...
<!-- Chèn hình: report_images/img_00_cell-06-eda.png -->
...
<!-- Chèn hình: report_images/img_01_cell-19-lstm-eval.png -->
*Hình 2: LSTM – Training curve (Accuracy)*

<!-- Chèn hình: report_images/img_02_cell-19-lstm-eval.png -->
...
<!-- Chèn hình: report_images/img_03_cell-22-gru-eval.png -->
*Hình 4: GRU – Training curve (Accuracy)*

<!-- Chèn hình: report_images/img_04_cell-22-gru-eval.png -->
...
<!-- Chèn hình: report_images/img_05_cell-25-cnn-eval.png -->
*Hình 6: CNN – Training curve (Accuracy)*

<!-- Chèn hình: report_images/img_06_cell-25-cnn-eval.png -->
...
<!-- Chèn hình: report_images/img_07_cell-27-chart.png -->
